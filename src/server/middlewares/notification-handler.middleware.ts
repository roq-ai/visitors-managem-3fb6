...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'An online applicant has submitted an application..create': {
    roles: ['administrator', 'employee'],
    key: 'application_submitted',
    tenantPath: [],
    userPath: [],
  },
  'A security personnel has triggered a security alert..create': {
    roles: ['administrator', 'security-personnel'],
    key: 'security_alert',
    tenantPath: [],
    userPath: [],
  },
  'A visitor has checked in at the front desk..create': {
    roles: ['administrator', 'employee', 'security-personnel'],
    key: 'visitor_checkin',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['administrator', 'employee', 'security-personnel', 'visitor', 'online-applicant'];
