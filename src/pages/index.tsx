  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Visitors Management System, your solution for efficiently tracking visitor records and providing seamless online applications for visitor passes."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1558959357-685f9c7ace7b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aXNpdG9yJTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTU1NzQ5ODh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@proxyclick?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Proxyclick Visitor Management System`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Visitors Management System, your solution for efficiently tracking visitor records and providing seamless online applications for visitor passes.`}
            </Text>
            <Box
